function balls() {
    ...
    while (balls.length < 100) {   //величина массива на 20 мячей

        let size = random(5, 10); //функция, генерирующая рандомный размер
        ...
        let ball = new Ball(  //Задаём рандомные свойства мячам (см. функцию создания мячей)
            ...
            random(-8, 8), //VelX
            random(-8, 8), //VelY, при болшьем числе увеличится скорость
